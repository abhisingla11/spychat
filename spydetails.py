...
spy = Spy('Abhishek', 'Mr.', 24, 4.7)                    #main user

friend_one = Spy('rahul', 'Mr.', 4.9, 27)               #first friend
friend_two = Spy('chandan', 'Mr.', 4.39, 21)              #second friend
friend_three = Spy('vasu', 'Mr.', 4.95, 37)             #third freind
